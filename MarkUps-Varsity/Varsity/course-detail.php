          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="course.html">Politektik Negeri Malang</a></li>                
                <li><a href="course-detail.html">Universitas Negeri Brawijawa</a></li>
                <li><a href="course-detail.html">Universitas Negeri Malang(UM)</a></li>                
              </ul>
            </li>           
